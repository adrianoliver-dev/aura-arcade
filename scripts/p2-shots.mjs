...
try {
  ...
  await shot(browser, 'action-390.png', 390, 844, `${origin}/jugar?shot=action`, 'SOLTÁ DENTRO DEL ARO NARANJA', 700)
  ...
  await shot(browser, 'gameplay-1920x1080.png', 1920, 1080, `${origin}/jugar?shot=action`, 'SOLTÁ DENTRO DEL ARO NARANJA', 800)
