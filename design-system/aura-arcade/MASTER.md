...
**Project:** Aura Arcade
**Generated:** 2026-09-17 15:34:20
**Category:** Space Tech / Aerospace
**Design Dials:** Variance 6/10 (Balanced / Modern) | Motion 8/10 (Complex) | Density 7/10 (Standard)
...
| Accent/CTA | `#16B57D` | `--color-accent` |
| On Accent/CTA | `#0B0B10` | `--color-on-accent` |
